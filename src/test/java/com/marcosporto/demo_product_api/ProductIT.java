...
public class ProductIT {
    ...
    public void shouldReturnStatus201WhenCreatingProduct() {
        ProductResponseDto responseBody = testClient
                ...
                .bodyValue(new ProductCreateDto("teste de produto", "descrição do produto",
                        500.00, 100L))
                .exchange()
    ...
    public void shouldReturnStatus422WhenCreatingProductWithInvalidData() {
        ErrorMessage responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "marcos@gmail.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new ProductCreateDto("", "", 500.00, 100l))
                .exchange()
    ...
    public void shouldReturnStatus422WhenCreatingProductWithNameLessThan3haracters() {
        ErrorMessage responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "marcos@gmail.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new ProductCreateDto("te", "descrição do produto", 500.00, 100l))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void shouldReturnStatus422WhenCreatingProductWithPriceNegative() {
        ErrorMessage responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "marcos@gmail.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new ProductCreateDto("te", "descrição do produto", -10.00, 100l))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void shouldReturnResponse200ToChangeProduct() {
        testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "marcos@gmail.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new ProductUpdateDto("teste123", "teste descrição", 55.00, 100l))
                .exchange()
                .expectStatus()
                .isOk();
    }
